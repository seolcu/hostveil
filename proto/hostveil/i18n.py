...
MESSAGES = {
    "en": {
        "cli.help.scan": "Scan a Docker Compose file or directory for security findings.",
        "cli.help.quick_fix": "Apply only safe, low-risk fixes.",
        ...
        "cli.overall_score": "Overall safety score: {score}/100 (100 = safest)",
        "cli.axis_scores": "Safety by category (100 = safest)",
        ...
        "cli.safe_fix_preview_only": "Preview only; no files were changed.",
        "cli.all_fix_none": "No fixes are available for this compose file.",
        "cli.all_fix_plan": "Planned changes: {summary}",
        "cli.all_fix_part_safe": "{count} safe fix(es)",
        "cli.all_fix_part_guided": "review-required privileged-container updates",
        "cli.all_fix_prompt": "Apply all available fixes, including review-required changes, to {path}? [y/N]: ",
        "cli.all_fix_cancelled": "Changes cancelled.",
        "cli.all_fix_preview_only": "Preview only; no files were changed.",
        "cli.all_fix_guided_applied": "Applied review-required privileged-container updates.",
