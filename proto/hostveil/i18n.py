...
MESSAGES = {
    "en": {
        ...
        "cli.patch_fix_none": "No fixes are available for this compose file.",
        "cli.patch_fix_plan": "Planned changes: {summary}",
        "cli.patch_part_safe": "{count} safe fix(es)",
        "cli.patch_part_guided": "guided privileged-container updates",
        "cli.patch_fix_prompt": "Apply all of these changes to {path}? [y/N]: ",
        "cli.patch_fix_cancelled": "Changes cancelled.",
        "cli.patch_fix_preview_only": "Preview only; no files were changed.",
        "cli.patch_guided_applied": "Applied guided privileged-container updates.",
