...
수정이 바꾼 파일은 롤백으로 전부 바이트 단위까지 복원됐습니다. 체크포인트 37개에
걸쳐 6개 중 6개입니다. 검토 수정 16건 중 7건은 되돌릴 것이 애초에 없습니다.
이미지 갱신 6건과 unattended-upgrades 활성화입니다. hostveil은
...
네트워킹, 환경 변수 속 비밀값이 그렇습니다. Lynis 경고 4건 중 2건은 hostveil이
